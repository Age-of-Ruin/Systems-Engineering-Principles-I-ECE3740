...
#define STACK_USE_TCP_LED_PB_CONSOLE_SERVER //***ADDED***
...
#define MY_DEFAULT_HOST_NAME			"mx37"
...
#define MY_DEFAULT_MAC_BYTE6            (0x37)	// 

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (0x37ul)
...
#define MY_DEFAULT_GATE_BYTE4           (55ul)
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE4		(55ul)
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(12669 + (10*2+44+200+20) + (2+44+152+1)) //***ADDED***
//	#define TCP_PIC_RAM_SIZE					(16384ul)
	...
	#define TCP_SOCKET_TYPES
        ...
        #define TCP_PURPOSE_TCP_LED_PB_CONSOLE_SERVER 13 //***ADDED***
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
            ...
            {TCP_PURPOSE_TCP_LED_PB_CONSOLE_SERVER, TCP_PIC_RAM, 152, 1}, //***ADDED***
		};
