...
public abstract class AbstractServer implements Runnable{
    ...
    public AbstractServer(int portNumber, int backlog, clientcommandhandler.ClientCommandHandler myClientCommand, mx7serverconnection.Client mx7Client) {
    ...
    public void listen() {
        try {
            ...
            System.err.println("Cannot start listen thread, exiting program.");
            System.exit(1);
        }
    }
        ...
        while (true) {
            if (doListen == true) {
                try {
                    ...
                    mx7Client.setClientConnection(theCC);
