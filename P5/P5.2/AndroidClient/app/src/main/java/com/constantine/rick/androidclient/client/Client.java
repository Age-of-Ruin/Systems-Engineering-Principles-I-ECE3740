package com.constantine.rick.androidclient.client;
...
public class Client implements Runnable {
    ...
    OutputStream output;
    Socket clientSocket;
    com.constantine.rick.androidclient.servermessagehandler.ServerMessageHandler myServerMessageHandler;
    com.constantine.rick.androidclient.clientGUI.ClientGUI myUI;
    boolean stopThisThread = false;
    boolean isConnected = false;
    int portNumber;
    InetAddress IPAddress;

    public Client(String IPAddress, int portNumber, com.constantine.rick.androidclient.clientGUI.ClientGUI myUI) {
        try {
        ...
        this.myUI = myUI;
        this.myServerMessageHandler = new com.constantine.rick.androidclient.servermessagehandler.ServerMessageHandler(this);
    }
